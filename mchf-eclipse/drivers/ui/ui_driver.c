...
void UiDriver_Init()
{
    ...
    UiLcdHy28_TouchscreenInit((ts.flags1 & FLAGS1_REVERSE_TOUCHSCREEN_X)?true:false,
            (ts.flags1 & FLAGS1_REVERSE_TOUCHSCREEN_Y)?true:false,
            (ts.flags2 & FLAGS2_MIRRORED_TOUCHSCREEN)?true:false
                    );
