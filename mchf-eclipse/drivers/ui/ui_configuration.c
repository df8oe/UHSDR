...
const ConfigEntryDescriptor ConfigEntryInfo[] =
{
    ...
    { ConfigEntry_Int32_16, EEPROM_RX_IQ_20M_GAIN_BALANCE,&ts.rx_iq_gain_balance[IQ_20M].value[IQ_TRANS_ON],IQ_BALANCE_OFF,  MIN_IQ_GAIN_BALANCE, MAX_IQ_GAIN_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_RX_IQ_20M_PHASE_BALANCE,&ts.rx_iq_phase_balance[IQ_20M].value[IQ_TRANS_ON],IQ_BALANCE_OFF,  MIN_IQ_PHASE_BALANCE, MAX_IQ_PHASE_BALANCE},
    ...
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_20_PHASE_BALANCE,&ts.tx_iq_phase_balance[IQ_20M].value[IQ_TRANS_ON],IQ_BALANCE_OFF, MIN_IQ_PHASE_BALANCE, MAX_IQ_PHASE_BALANCE},
