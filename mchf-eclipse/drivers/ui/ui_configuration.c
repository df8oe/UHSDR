...
const ConfigEntryDescriptor ConfigEntryInfo[] =
{
    ...
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_80M_GAIN_BALANCE,&ts.tx_iq_gain_balance[IQ_TRANS_ON][IQ_80M],0, MIN_IQ_GAIN_BALANCE, MAX_IQ_GAIN_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_10M_GAIN_BALANCE,&ts.tx_iq_gain_balance[IQ_TRANS_ON][IQ_10M],0, MIN_IQ_GAIN_BALANCE, MAX_IQ_GAIN_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_80M_PHASE_BALANCE,&ts.tx_iq_phase_balance[IQ_TRANS_ON][IQ_80M],0, MIN_IQ_PHASE_BALANCE, MAX_IQ_PHASE_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_10M_PHASE_BALANCE,&ts.tx_iq_phase_balance[IQ_TRANS_ON][IQ_10M],0, MIN_IQ_PHASE_BALANCE, MAX_IQ_PHASE_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_RX_IQ_80M_GAIN_BALANCE,&ts.rx_iq_gain_balance[IQ_TRANS_ON][IQ_80M],0, MIN_IQ_GAIN_BALANCE, MAX_IQ_GAIN_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_RX_IQ_10M_GAIN_BALANCE,&ts.rx_iq_gain_balance[IQ_TRANS_ON][IQ_10M],0,  MIN_IQ_GAIN_BALANCE, MAX_IQ_GAIN_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_RX_IQ_80M_PHASE_BALANCE,&ts.rx_iq_phase_balance[IQ_TRANS_ON][IQ_80M],0,  MIN_IQ_PHASE_BALANCE, MAX_IQ_PHASE_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_RX_IQ_10M_PHASE_BALANCE,&ts.rx_iq_phase_balance[IQ_TRANS_ON][IQ_10M],0,  MIN_IQ_PHASE_BALANCE, MAX_IQ_PHASE_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_RX_IQ_20M_GAIN_BALANCE,&ts.rx_iq_gain_balance[IQ_TRANS_ON][IQ_20M],0,  MIN_IQ_GAIN_BALANCE, MAX_IQ_GAIN_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_RX_IQ_20M_PHASE_BALANCE,&ts.rx_iq_phase_balance[IQ_TRANS_ON][IQ_20M],0,  MIN_IQ_PHASE_BALANCE, MAX_IQ_PHASE_BALANCE},
    ...
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_20M_GAIN_BALANCE,&ts.tx_iq_gain_balance[IQ_TRANS_ON][IQ_20M],0, MIN_IQ_GAIN_BALANCE, MAX_IQ_GAIN_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_20_PHASE_BALANCE,&ts.tx_iq_phase_balance[IQ_TRANS_ON][IQ_20M],0, MIN_IQ_PHASE_BALANCE, MAX_IQ_PHASE_BALANCE},
