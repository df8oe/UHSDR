...
const ConfigEntryDescriptor ConfigEntryInfo[] =
{
    ...
    { ConfigEntry_UInt8, EEPROM_KEYER_SPEED,&ts.cw_keyer_speed,DEFAULT_KEYER_SPEED,MIN_KEYER_SPEED, MAX_KEYER_SPEED},
    { ConfigEntry_UInt8, EEPROM_KEYER_MODE,&ts.cw_keyer_mode,CW_MODE_IAM_B, 0, CW_MAX_MODE},
