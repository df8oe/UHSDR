...
//    { ConfigEntry_Int32_16, EEPROM_RX_GAIN,&ts.rf_gain,DEFAULT_RF_GAIN,0,MAX_RF_GAIN},
    ...
    { ConfigEntry_Int32_16, EEPROM_AGC_WDSP_THRESH,&ts.agc_wdsp_conf.thresh, 20,-20,120},
    { ConfigEntry_UInt8, EEPROM_AGC_WDSP_SLOPE,&ts.agc_wdsp_conf.slope, 70,0,200},
    { ConfigEntry_Int32_16, EEPROM_AGC_WDSP_TAU_DECAY_0,&ts.agc_wdsp_conf.tau_decay[0], 4000,100,5000},
    { ConfigEntry_Int32_16, EEPROM_AGC_WDSP_TAU_DECAY_1,&ts.agc_wdsp_conf.tau_decay[1], 2000,100,5000},
    { ConfigEntry_Int32_16, EEPROM_AGC_WDSP_TAU_DECAY_2,&ts.agc_wdsp_conf.tau_decay[2], 500,100,5000},
    { ConfigEntry_Int32_16, EEPROM_AGC_WDSP_TAU_DECAY_3,&ts.agc_wdsp_conf.tau_decay[3], 250,100,5000},
    { ConfigEntry_Int32_16, EEPROM_AGC_WDSP_TAU_DECAY_4,&ts.agc_wdsp_conf.tau_decay[4], 50,100,5000},
    { ConfigEntry_Int32_16, EEPROM_AGC_WDSP_TAU_HANG_DECAY,&ts.agc_wdsp_conf.tau_hang_decay, 500,100,5000},
...
//    { ConfigEntry_UInt8, EEPROM_S_METER,&ts.s_meter,0,0,2},
	...
	{ ConfigEntry_UInt8, EEPROM_ADJ_TX_IQ_SOMEBANDS,&ts.adj_tx_iq_somebands,1,0,1},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_20M_GAIN_BALANCE,&ts.tx_iq_gain_balance[IQ_20M].value[IQ_TRANS_ON],IQ_BALANCE_OFF, MIN_IQ_GAIN_BALANCE, MAX_IQ_GAIN_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_20M_PHASE_BALANCE,&ts.tx_iq_phase_balance[IQ_20M].value[IQ_TRANS_ON],IQ_BALANCE_OFF, MIN_IQ_PHASE_BALANCE, MAX_IQ_PHASE_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_15M_GAIN_BALANCE,&ts.tx_iq_gain_balance[IQ_15M].value[IQ_TRANS_ON],IQ_BALANCE_OFF, MIN_IQ_GAIN_BALANCE, MAX_IQ_GAIN_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_15M_PHASE_BALANCE,&ts.tx_iq_phase_balance[IQ_15M].value[IQ_TRANS_ON],IQ_BALANCE_OFF, MIN_IQ_PHASE_BALANCE, MAX_IQ_PHASE_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_10M_UP_GAIN_BALANCE,&ts.tx_iq_gain_balance[IQ_10M_UP].value[IQ_TRANS_ON],IQ_BALANCE_OFF, MIN_IQ_GAIN_BALANCE, MAX_IQ_GAIN_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_10M_UP_PHASE_BALANCE,&ts.tx_iq_phase_balance[IQ_10M_UP].value[IQ_TRANS_ON],IQ_BALANCE_OFF, MIN_IQ_PHASE_BALANCE, MAX_IQ_PHASE_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_20M_GAIN_BALANCE_TRANS_OFF,&ts.tx_iq_gain_balance[IQ_20M].value[IQ_TRANS_OFF],IQ_BALANCE_OFF,  MIN_IQ_GAIN_BALANCE, MAX_IQ_GAIN_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_20M_PHASE_BALANCE_TRANS_OFF,&ts.tx_iq_phase_balance[IQ_20M].value[IQ_TRANS_OFF],IQ_BALANCE_OFF,  MIN_IQ_PHASE_BALANCE, MAX_IQ_PHASE_BALANCE},
    { ConfigEntry_Int32_16, EEPROM_TX_IQ_15M_GAIN_BALANCE_TRANS_OFF,&ts.tx_iq_gain_balance[IQ_15M].value[IQ_TRANS_OFF],IQ_BALANCE_OFF,  MIN_IQ_GAIN_BALANCE, MAX_IQ_GAIN_BALANCE},
    ...
    { ConfigEntry_UInt8, EEPROM_TX_POWER_LEVEL_VSWR3,&ts.tx_power_level_vswr3,PA_LEVEL_DEFAULT,0,PA_LEVEL_0_5W},
    { ConfigEntry_UInt8, EEPROM_TX_POWER_LEVEL_VSWR5,&ts.tx_power_level_vswr5,PA_LEVEL_DEFAULT,0,PA_LEVEL_0_5W},
