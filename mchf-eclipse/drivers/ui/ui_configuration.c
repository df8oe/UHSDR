...
const ConfigEntryDescriptor ConfigEntryInfo[] =
{
    ...
    { ConfigEntry_UInt8, EEPROM_LOW_POWER_THRESHOLD,&ts.low_power_threshold,LOW_POWER_THRESHOLD_DEFAULT,LOW_POWER_THRESHOLD_MIN,LOW_POWER_THRESHOLD_MAX},
    { ConfigEntry_UInt8, EEPROM_LOW_POWER_SHUTDOWN,&ts.low_power_shutdown,1,0,1},
