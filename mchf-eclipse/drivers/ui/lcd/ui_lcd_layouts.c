...
static const touchaction_descr_t R320240_touchactions_normal[] =
{
		...
		{ {R320240_LEFTBOXES_IND_X,R320240_LEFTBOXES_IND_Y,LEFTBOX_WIDTH,LEFTBOX_ROW_H}, Codec_RestartI2S,NULL }, // DSP Box: Restart I2S
...
const LcdLayout LcdLayouts[LcdLayoutsCount]=
{
		...
		{		//320x240
				.SizeX=320,
				.SizeY=240,
				.StartUpScreen_START_X=0,
				.StartUpScreen_START_Y=10,
				.SpectrumWindow={  .x = 58, .y = 128, .w = 260, .h = 94  },
				.SpectrumWindowPadding=2,

				.TUNE_FREQ_X=R320240_TUNE_FREQ_X,
				.TUNE_FREQ_Y=R320240_TUNE_FREQ_Y,
				...
				.TUNE_SFREQ_X=R320240_TUNE_SFREQ_X,
				.TUNE_SFREQ_Y=R320240_TUNE_SFREQ_Y,
				.DisplayDbm_X=R320240_DisplayDbm_X,
				.DisplayDbm_Y=R320240_DisplayDbm_Y,
				.MEMORYLABEL_X=R320240_MEMORYLABEL_X,
				.MEMORYLABEL_Y=R320240_MEMORYLABEL_Y,

				.BAND_MODE_X=R320240_BAND_MODE_X,
				.BAND_MODE_Y=R320240_BAND_MODE_Y,
				.BAND_MODE_MASK_X=R320240_BAND_MODE_MASK_X,
				.BAND_MODE_MASK_Y=R320240_BAND_MODE_MASK_Y,
				.BAND_MODE_MASK_H=R320240_BAND_MODE_MASK_H,
				.BAND_MODE_MASK_W=R320240_BAND_MODE_MASK_W,

				.DEMOD_MODE_X=R320240_DEMOD_MODE_X,
				.DEMOD_MODE_Y=R320240_DEMOD_MODE_Y,
				.DEMOD_MODE_MASK_X=R320240_DEMOD_MODE_MASK_X,
				.DEMOD_MODE_MASK_Y=R320240_DEMOD_MODE_MASK_Y,
				.DEMOD_MODE_MASK_W=R320240_DEMOD_MODE_MASK_W,
				.DEMOD_MODE_MASK_H=R320240_DEMOD_MODE_MASK_H,
				.TUNE_STEP={.x=R320240_TUNE_STEP_X, .y=R320240_TUNE_STEP_Y, .h=R320240_TUNE_STEP_MASK_H, .w=R320240_TUNE_STEP_MASK_W},

				.ENCODER_IND_X=R320240_ENCODER_IND_X,
				.ENCODER_IND_Y=R320240_ENCODER_IND_Y,
				.ENCODER_MODE=MODE_VERTICAL,

				.DIGMODE={.x=R320240_DIGMODE_IND_X,.y=R320240_DIGMODE_IND_Y,.h=R320240_DIGMODE_IND_H},

				.LEFTBOXES_IND_X=R320240_LEFTBOXES_IND_X,
				.LEFTBOXES_IND_Y=R320240_LEFTBOXES_IND_Y,
				.LEFTBOXES_MODE=MODE_VERTICAL,

				.PW_IND_X=R320240_PW_IND_X,
				.PW_IND_Y=R320240_PW_IND_Y,
				.TEMP_IND={.x=0,.y=0},
				.RTC_IND={.x=0,.y=79},
		...
		{		//480x320
				.SizeX=480,
				.SizeY=320,
				.StartUpScreen_START_X=80,
				.StartUpScreen_START_Y=60,
				.SpectrumWindow={ .x = 0, .y = 110, .w = 480, .h = 176 },
				.SpectrumWindowPadding=0,

				.TUNE_FREQ_X=R480320_TUNE_FREQ_X,
				.TUNE_FREQ_Y=R480320_TUNE_FREQ_Y,
				...
				.TUNE_SFREQ_X=R480320_TUNE_SFREQ_X,
				.TUNE_SFREQ_Y=R480320_TUNE_SFREQ_Y,
				.DisplayDbm_X=R480320_DisplayDbm_X,
				.DisplayDbm_Y=R480320_DisplayDbm_Y,
				.MEMORYLABEL_X=R480320_MEMORYLABEL_X,
				.MEMORYLABEL_Y=R480320_MEMORYLABEL_Y,

				.BAND_MODE_X=R480320_BAND_MODE_X,
				.BAND_MODE_Y=R480320_BAND_MODE_Y,
				.BAND_MODE_MASK_X=R480320_BAND_MODE_MASK_X,
				.BAND_MODE_MASK_Y=R480320_BAND_MODE_MASK_Y,
				.BAND_MODE_MASK_H=R480320_BAND_MODE_MASK_H,
				.BAND_MODE_MASK_W=R480320_BAND_MODE_MASK_W,

				.DEMOD_MODE_X=R480320_DEMOD_MODE_X,
				.DEMOD_MODE_Y=R480320_DEMOD_MODE_Y,
				.DEMOD_MODE_MASK_X=R480320_DEMOD_MODE_MASK_X,
				.DEMOD_MODE_MASK_Y=R480320_DEMOD_MODE_MASK_Y,
				.DEMOD_MODE_MASK_W=R480320_DEMOD_MODE_MASK_W,
				.DEMOD_MODE_MASK_H=R480320_DEMOD_MODE_MASK_H,
				.TUNE_STEP={.x=R480320_TUNE_STEP_X, .y=R480320_TUNE_STEP_Y, .h=R480320_TUNE_STEP_MASK_H, .w=R480320_TUNE_STEP_MASK_W},

				.ENCODER_IND_X=R480320_ENCODER_IND_X,
				.ENCODER_IND_Y=R480320_ENCODER_IND_Y,
				.ENCODER_MODE=MODE_HORIZONTAL,

				.DIGMODE={.x=R480320_DIGMODE_IND_X,.y=R480320_DIGMODE_IND_Y,.h=R480320_DIGMODE_IND_H},

				.LEFTBOXES_IND_X=R480320_LEFTBOXES_IND_X,
				.LEFTBOXES_IND_Y=R480320_LEFTBOXES_IND_Y,
				.LEFTBOXES_MODE=MODE_HORIZONTAL,

				.PW_IND_X=R480320_PW_IND_X,
				.PW_IND_Y=R480320_PW_IND_Y,
				.TEMP_IND={.x=370,.y=64},
				.RTC_IND={.x=415,.y=80},
				...
				.CW_DECODER_WPM_X=420,
				.CW_DECODER_WPM_Y=290,
