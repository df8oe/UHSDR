...
const MenuDescriptor confGroup[] =
{
    ...
    { MENU_CONF, MENU_ITEM, CONFIG_80M_RX_IQ_GAIN_BAL,"240", "RX IQ Balance (80m)", UiMenuDesc("See Wiki Adjustments and Calibration.") },
    { MENU_CONF, MENU_ITEM, CONFIG_80M_RX_IQ_PHASE_BAL,"241","RX IQ Phase   (80m)", UiMenuDesc("See Wiki Adjustments and Calibration.") },
    { MENU_CONF, MENU_ITEM, CONFIG_10M_RX_IQ_GAIN_BAL,"242", "RX IQ Balance (10m)", UiMenuDesc("See Wiki Adjustments and Calibration.") },
    { MENU_CONF, MENU_ITEM, CONFIG_10M_RX_IQ_PHASE_BAL,"243","RX IQ Phase   (10m)", UiMenuDesc("See Wiki Adjustments and Calibration.") },
    { MENU_CONF, MENU_ITEM, CONFIG_80M_TX_IQ_GAIN_BAL,"250", "TX IQ Balance (80m)", UiMenuDesc("See Wiki Adjustments and Calibration.") },
