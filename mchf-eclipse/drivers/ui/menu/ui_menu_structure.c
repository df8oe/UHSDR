...
//    { MENU_BASE, MENU_ITEM, MENU_CUSTOM_AGC, NULL, "AGC STD Custom Speed (+=Slower)", UiMenuDesc("Standard AGC:  If AGC STD Mode is set to CUSTOM, this controls the speed setting of AGC") },
    ...
    { MENU_BASE, MENU_ITEM, MENU_TCXO_MODE, &ts.enable_tcxo, "TCXO Off/On/Stop", UiMenuDesc("The software TCXO can be turned ON (set frequency is adjusted so that generated frequency matches the wanted frequency); OFF (no correction or measurement done); or STOP (no correction but measurement).") },
...
const MenuDescriptor powGroup[] =
{
    ...
    { MENU_POW, MENU_ITEM, CONFIG_REF_POWER, NULL, "Reference Power REF PWR", UiMenuDesc("Displays the power level which is used as reference power during PA calibration. This value depends on the actual rf hardware, it is 5W for the mcHF") },
    ...
    { MENU_POW, MENU_ITEM, CONFIG_2200M_REFPWR_ADJUST,&band_enabled[BAND_MODE_2200],"2200m REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_630M_REFPWR_ADJUST,&band_enabled[BAND_MODE_630],"630m  REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_160M_REFPWR_ADJUST, NULL, "160m  REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_80M_REFPWR_ADJUST, NULL, "80m   REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_60M_REFPWR_ADJUST, NULL, "60m   REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_40M_REFPWR_ADJUST, NULL, "40m   REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_30M_REFPWR_ADJUST, NULL, "30m   REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_20M_REFPWR_ADJUST, NULL, "20m   REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_17M_REFPWR_ADJUST, NULL, "17m   REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_15M_REFPWR_ADJUST, NULL, "15m   REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_12M_REFPWR_ADJUST, NULL, "12m   REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_10M_REFPWR_ADJUST, NULL, "10m   REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_6M_REFPWR_ADJUST,&band_enabled[BAND_MODE_6],"6m    REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_4M_REFPWR_ADJUST,&band_enabled[BAND_MODE_4],"4m    REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_2M_REFPWR_ADJUST,&band_enabled[BAND_MODE_2],"2m    REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_70CM_REFPWR_ADJUST,&band_enabled[BAND_MODE_70],"70cm  REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_23CM_REFPWR_ADJUST,&band_enabled[BAND_MODE_23],"23cm  REF PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve reference power on this band. See Adjustment and Calibration for more information.") },
