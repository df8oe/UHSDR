...
const MenuDescriptor confGroup[] =
{
    ...
    { MENU_CONF, MENU_ITEM, CONFIG_RF_FWD_PWR_NULL, NULL, "Pwr. Det. Null", UiMenuDesc(":soon:") },
...
const MenuDescriptor powGroup[] =
{
    ...
    { MENU_POW, MENU_ITEM, CONFIG_REDUCE_POWER_ON_LOW_BANDS, NULL, "Reduce Power on Low Bands", UiMenuDesc("If set (recommended!)  frequencies below 8Mhz require higher power adjust values. This permits better control of generated power on these frequencies.") },
    ...
    { MENU_POW, MENU_ITEM, CONFIG_2200M_5W_ADJUST,&ts.rfmod_present,"2200m 5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_630M_5W_ADJUST,&ts.rfmod_present,"630m  5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_160M_5W_ADJUST, NULL, "160m  5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_80M_5W_ADJUST, NULL, "80m   5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_60M_5W_ADJUST, NULL, "60m   5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_40M_5W_ADJUST, NULL, "40m   5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_30M_5W_ADJUST, NULL, "30m   5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_20M_5W_ADJUST, NULL, "20m   5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_17M_5W_ADJUST, NULL, "17m   5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_15M_5W_ADJUST, NULL, "15m   5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_12M_5W_ADJUST, NULL, "12m   5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_10M_5W_ADJUST, NULL, "10m   5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_6M_5W_ADJUST,&ts.rfmod_present,"6m    5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_4M_5W_ADJUST,&ts.rfmod_present,"4m    5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_2M_5W_ADJUST,&ts.vhfuhfmod_present,"2m    5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_70CM_5W_ADJUST,&ts.vhfuhfmod_present,"70cm  5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_23CM_5W_ADJUST,&ts.vhfuhfmod_present,"23cm  5W PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_2200M_FULL_POWER_ADJUST,&ts.rfmod_present,"2200m Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_630M_FULL_POWER_ADJUST,&ts.rfmod_present,"630m  Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_160M_FULL_POWER_ADJUST, NULL, "160m  Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_80M_FULL_POWER_ADJUST, NULL, "80m   Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_60M_FULL_POWER_ADJUST, NULL, "60m   Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_40M_FULL_POWER_ADJUST, NULL, "40m   Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_30M_FULL_POWER_ADJUST, NULL, "30m   Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_20M_FULL_POWER_ADJUST, NULL, "20m   Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_17M_FULL_POWER_ADJUST, NULL, "17m   Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_15M_FULL_POWER_ADJUST, NULL, "15m   Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_12M_FULL_POWER_ADJUST, NULL, "12m   Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_10M_FULL_POWER_ADJUST, NULL, "10m   Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_6M_FULL_POWER_ADJUST,&ts.rfmod_present,"6m    Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_4M_FULL_POWER_ADJUST,&ts.rfmod_present,"4m    Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_2M_FULL_POWER_ADJUST,&ts.vhfuhfmod_present,"2m    Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_70CM_FULL_POWER_ADJUST,&ts.vhfuhfmod_present,"70cm  Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_23CM_FULL_POWER_ADJUST,&ts.vhfuhfmod_present,"23cm  Full PWR Adjust", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_2200M_ADJ,&ts.rfmod_present,"2200m Coupling Adj.", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_630M_ADJ,&ts.rfmod_present,"630m Coupling Adj.", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_160M_ADJ, NULL, "160m Coupling Adj.", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_80M_ADJ, NULL, "80m  Coupling Adj.", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_40M_ADJ, NULL, "40m  Coupling Adj.", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_20M_ADJ, NULL, "20m  Coupling Adj.", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_15M_ADJ, NULL, "15m  Coupling Adj.", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_6M_ADJ,&ts.rfmod_present, "6m   Coupling Adj.", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_2M_ADJ,&ts.vhfuhfmod_present, "2m   Coupling Adj.", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_70CM_ADJ,&ts.vhfuhfmod_present, "70cm Coupling Adj.", UiMenuDesc(":soon:") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_23CM_ADJ,&ts.vhfuhfmod_present, "23cm Coupling Adj.", UiMenuDesc(":soon:") },
