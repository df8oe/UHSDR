...
//    { MENU_BASE, MENU_ITEM, MENU_SSB_NARROW_FILT,"029","CW Filt in SSB Mode", UiMenuDesc(":soon:") },
    ...
    { MENU_BASE, MENU_ITEM, MENU_SAM_FADE_LEVELER, NULL, "SAM Fade Leveler", UiMenuDesc("Fade leveler of the SAM demodulator can be switched ON/OFF. If ON, it can be expected to better remove the effect of selective fading.") },
...
const MenuDescriptor confGroup[] =
{
    ...
    { MENU_CONF, MENU_ITEM, CONFIG_FREQUENCY_CALIBRATE, NULL, "Freq. Calibrate", UiMenuDesc("Adjust the frequency correction of the local oscillator. Select 1Hz step size and measure TX frequency and adjust until both match. Or receive a know reference signal and zero-beat it and then adjust. More information in the Wiki.") },
    ...
    { MENU_CONF, MENU_ITEM, CONFIG_RF_FWD_PWR_NULL, NULL, "Pwr. Det. Null", UiMenuDesc(" Set the forward and reverse power sensors ADC zero power offset. This setting is enabled ONLY when â€œDisp. Pwr (mW)â€�, is enabled. Needs SWR meter hardware modification to work. See Wiki Adjustment and Calibration.") },
    ...
    { MENU_CONF, MENU_ITEM, CONFIG_80M_RX_IQ_GAIN_BAL, NULL, "RX IQ Balance (80m)", UiMenuDesc("IQ Balance Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
    { MENU_CONF, MENU_ITEM, CONFIG_80M_RX_IQ_PHASE_BAL, NULL, "RX IQ Phase   (80m)", UiMenuDesc("IQ Phase Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
    { MENU_CONF, MENU_ITEM, CONFIG_10M_RX_IQ_GAIN_BAL, NULL, "RX IQ Balance (10m)", UiMenuDesc("IQ Balance Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
    { MENU_CONF, MENU_ITEM, CONFIG_10M_RX_IQ_PHASE_BAL, NULL, "RX IQ Phase   (10m)", UiMenuDesc("IQ Phase Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable. See Wiki Adjustments and Calibration.") },
...
const MenuDescriptor powGroup[] =
{
    ...
    { MENU_POW, MENU_ITEM, CONFIG_REDUCE_POWER_ON_LOW_BANDS, NULL, "Reduce Power on Low Bands", UiMenuDesc("If set (recommended!)  frequencies below 8Mhz (40m or lower) require higher power adjust values. This permits better control of generated power on these frequencies.") },
    ...
    { MENU_POW, MENU_ITEM, CONFIG_2200M_5W_ADJUST,&ts.rfmod_present,"2200m 5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_630M_5W_ADJUST,&ts.rfmod_present,"630m  5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    ...
    { MENU_POW, MENU_ITEM, CONFIG_6M_5W_ADJUST,&ts.rfmod_present,"6m    5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_4M_5W_ADJUST,&ts.rfmod_present,"4m    5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_2M_5W_ADJUST,&ts.vhfuhfmod_present,"2m    5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_70CM_5W_ADJUST,&ts.vhfuhfmod_present,"70cm  5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_23CM_5W_ADJUST,&ts.vhfuhfmod_present,"23cm  5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_2200M_FULL_POWER_ADJUST,&ts.rfmod_present,"2200m Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_630M_FULL_POWER_ADJUST,&ts.rfmod_present,"630m  Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
    ...
    { MENU_POW, MENU_ITEM, CONFIG_6M_FULL_POWER_ADJUST,&ts.rfmod_present,"6m    Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_4M_FULL_POWER_ADJUST,&ts.rfmod_present,"4m    Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_2M_FULL_POWER_ADJUST,&ts.vhfuhfmod_present,"2m    Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_70CM_FULL_POWER_ADJUST,&ts.vhfuhfmod_present,"70cm  Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_23CM_FULL_POWER_ADJUST,&ts.vhfuhfmod_present,"23cm  Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_2200M_ADJ,&ts.rfmod_present,"2200m Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 2200m band power values. See Wiki.") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_630M_ADJ,&ts.rfmod_present,"630m Coupling Adj.", UiMenuDesc("Power Adjustment factor for the 630m band power values. See Wiki.") },
    ...
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_6M_ADJ,&ts.rfmod_present, "6m   Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 6m band power values. See Wiki.") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_2M_ADJ,&ts.vhfuhfmod_present, "2m   Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 2m band power values. See Wiki.") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_70CM_ADJ,&ts.vhfuhfmod_present, "70cm Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 70cm band power values. See Wiki.") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_23CM_ADJ,&ts.vhfuhfmod_present, "23cm Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 23cm band power values. See Wiki.") },
