...
//    CONFIG_MAX_RX_GAIN,
    ...
    CONFIG_2200M_REFPWR_ADJUST,
    CONFIG_630M_REFPWR_ADJUST,
    CONFIG_160M_REFPWR_ADJUST,
    CONFIG_80M_REFPWR_ADJUST,
    CONFIG_60M_REFPWR_ADJUST,
    CONFIG_40M_REFPWR_ADJUST,
    CONFIG_30M_REFPWR_ADJUST,
    CONFIG_20M_REFPWR_ADJUST,
    CONFIG_17M_REFPWR_ADJUST,
    CONFIG_15M_REFPWR_ADJUST,
    CONFIG_12M_REFPWR_ADJUST,
    CONFIG_10M_REFPWR_ADJUST,
    CONFIG_6M_REFPWR_ADJUST,
    CONFIG_4M_REFPWR_ADJUST,
    CONFIG_2M_REFPWR_ADJUST,
    CONFIG_70CM_REFPWR_ADJUST,
    CONFIG_23CM_REFPWR_ADJUST,
