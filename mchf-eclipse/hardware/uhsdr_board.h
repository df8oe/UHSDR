...
//	int16_t nr_mode;
	...
	bool vswr_protection;  // TRUE - VSWR protection of PA is activated
    uint8_t	tx_power_level_vswr3;		// TX power if VSWR>3
    uint8_t	tx_power_level_vswr5;		// TX power if VSWR>5
} TransceiverState;
//
